...
> **当前版本：正式版 1.0（CityUPedia 1.0）**
> 正式上线。对照城大官网核对了计算学院七大授课型硕士项目的核心课程，补全生物统计（MSBIOS）2 门核心课（PH5102/PH5103）与电子商贸（MSEC）信息安全核心课映射，并完成全站数据校验与 HTTP 加载测试，课程 PDF 覆盖率达 100%。
